...
param_grid = {
    ...
    'bootstrap': [False],
    'class_weight': ["balanced"]# Whether bootstrap samples are used when building trees
}
...
answer["ID"] = answer['nit_enmascarado'].astype(str)+"#"+answer['num_oblig_orig_enmascarado'].astype(str)+"#"+answer['num_oblig_enmascarado'].astype(str)
answer.drop(columns=["nit_enmascarado", "num_oblig_enmascarado", "num_oblig_orig_enmascarado", "fecha_var_rpta_alt"], inplace=True)
